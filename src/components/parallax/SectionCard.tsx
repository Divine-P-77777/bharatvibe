...
export default function SectionCard({
  ...
  const cardTheme = isDarkMode
    ? 'bg-gradient-to-r from-black-400 to-gray-900 text-orange-500 shadow-orange-600'
    : 'bg-gradient-to-r from-amber-400 to-rose-400 text-white shadow-gray-600';

  const postButtonTheme = isDarkMode
    ? 'bg-white/10 text-white border-sky-300'
    : 'bg-white text-black border-orange-500';

  return (
    <motion.div
      className={`relative rounded-3xl shadow-sm ${cardTheme} bg-opacity-90 backdrop-blur-xl p-8 shadow-2xl`}
    ...
    >
      ...
      <div className="flex justify-center mt-6" data-lenis-speed="2">
        <Link
          href={exploreLink}
